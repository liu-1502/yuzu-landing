            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-7 flex flex-wrap justify-center gap-3 lg:justify-start">
                <a
                  ...
                  className="group inline-flex h-10 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-btn bg-foreground px-[18px] text-[13.5px] font-semibold text-background outline-none transition-colors hover:bg-[color-mix(in_srgb,var(--foreground)_86%,var(--background))] focus-visible:ring-[3px] focus-visible:ring-ring/50"
                >
                  {hero.primary.label}
                ...
                <a
                  ...
                  className="inline-flex h-10 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-btn border border-line-strong bg-transparent px-[18px] text-[13.5px] font-semibold text-foreground outline-none transition-colors hover:border-accent hover:text-accent focus-visible:ring-[3px] focus-visible:ring-ring/50"
                >
