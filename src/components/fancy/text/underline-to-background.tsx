...
interface UnderlineProps {
  ...
  /**
   * SỬA SO VỚI BẢN GỐC: cho phép truyền thẳng prop của thẻ render qua `as`
   * (href, target, rel, aria-*...). Bản gốc chặn nên không dùng `as="a"` được.
   * Nếu chạy lại `shadcn add @fancy/underline-to-background` thì phải thêm lại.
   */
  [key: string]: unknown
}
...
const UnderlineToBackground = ({
  ...
  return (
    ...
    >
      <motion.span
        className="absolute block bg-current w-full"
        style={{
          height: "var(--underline-height)",
